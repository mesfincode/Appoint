        ...
        <div className={`  sm:max-w-[400px] w-full border-2 bg-gray-100 border-gray-200  cursor-pointer  p-4 rounded-lg`} onClick={onClick}>
            <div className=' flex flex-col gap-1  justify-between  items-center h-full'>
                <div className='w-[90px] h-[90px]'>
                    ...
                    <img src={profileUrl} alt="profile" className='w-[90px] h-[90px] object-fill rounded-full'  />
                ...
                <h1 className='text-center pt-1 px-2 min-h-[90px] max-w-[300px] w-full overflow-wrap-break-word'>{serviceDescription.length > 60 ? `${serviceDescription.slice(0, 60)}...` : serviceDescription}</h1>
